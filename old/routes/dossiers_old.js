    ...
    //console.log(req.params.codeMat);
     if(isNaN(parseInt(req.params.codeMat))){
        ...
        res.send({
         ...
         let req2 ='SELECT d.matricule, d.nom, d.prenom, d.sexe,d.Date,d.Section,';
          ...
          req2 +=' FROM dossiers d, dosexamens res WHERE d.Identifiant = res.Identifiant and d.matricule =? order by 2';
